...
jQuery(document).bind('gform_post_render', function(){
    ...
    heading_alt = '<span id="form-heading" class="reverse"><h2>SESSION INTER ENTREPRISES</h2><h3>Demander la création d\'une session à la carte</h3></span><hr><br><br>';
    if( jQuery('#form-heading').length == 0 ){
        jQuery('#gform_wrapper_11 form, #gform_wrapper_1 form, #gform_wrapper_9 form').prepend(heading);
        jQuery('#gform_wrapper_12 form').prepend(heading_alt);
    } 
