...
if(substr($url_parameters, -1) == '/') {
    $url_parameters = substr($url_parameters, 0, -1);
}
?>
...
<div class="full-width bg-gray p30 content-actu-formation">
	<div class="p030 clearfix">
		<h3>Les participants à cette formation ont également consulté les formations suivantes :</h3>

		<div class="row">

			<?php echo do_shortcode( '[formations_slider nb=-1 taxo="thematique"]' ); ?>
