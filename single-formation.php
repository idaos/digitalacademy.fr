...
$thema_color_str = get_field( 'couleur', 'thematique_'.$thematic->term_id );
?>
...
<!-- Heading -->
<div id="heading" class="container-slider main-slider slider-header<?php echo esc_attr( $thematic_css ); ?>">
    <div class="slick-slide">
        ...
        <!-- Thema name -->
        <div class="text-center<?php echo esc_attr( $thematic_css ); ?> w100" style="font-size: .6em;margin-top:1.5em;">
            <?php if ( ! empty( $thematic ) && ! empty( $thematic->name ) ) : ?>
            <p class="big-title">Thématique : <?php echo esc_html( $thematic->name ); ?></p>
            <?php endif; ?>
        </div>
    ...
    <div class="row clearfix" id="presentation">
        ...
        <div class="content-wrapper">
            ...
            <div class="col-sm-6">
                ...
                <!--
<div id="toggle-txt">&#43; En lire plus </div>
<div id="presentation-thema" class="">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-xs-12 col-sm-8 col-r">
                        ...
                        <div class="toggable info-item">
                            <p class="toggable-title"><strong>À qui s’adresse cette formation ?</strong></p>
                        ...
                        <div class="toggable info-item">
                            <p class="toggable-title"><strong>Quelle est la méthodologie pédagogique employée ?</strong></p>
                        ...
                        <div class="toggable info-item">
                            <p class="toggable-title"><strong>Quelles sont les modalités d'évaluation de l'apprenant ?</strong></p>
...
<div class="container-wp" id="programme-wrapper-<?php echo $thema_color_str; ?>">
                ...
                <div id="programme-flex-wrap" class="row alignLeft">
                    <div style="display:none;"><div style="display:none;"><ul>
                        ...
                        if ( get_field( 'programme_2' ) ){
                            $programme .= the_field( 'programme_2' );
                        }
                        if ( get_field( 'programme_3' ) ){
                            $programme .= the_field( 'programme_3' );
                        }
                        ...
                        <div class="col-sm-11" style="padding:0">
                            <table class="table-inscription" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <?php if (( $date_session - time() ) < 864000 ): ?>
                                    <!-- the session occure less than 10 days from now-->
                            ...
                            <br>
                            <small>** Les inscriptions aux sessions de formations sont closes 10 jours avant la date indiquée.</small>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab-scalable" class="tab-pane">
                                ...
                                <div class="content-wp">
                                    ...
                                    <a href="<?php echo $url; ?>/contact/?objet=Demande de devis pour un programme sur-mesure de la formation %22<?php the_title(); ?>%22" class="btn btn-red">Demander un devis</a>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
