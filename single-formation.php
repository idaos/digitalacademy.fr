            ...
            <div class="">
                <div class="content-wrapper">
                    <div class="row" style="padding-top:0">
                        <div class="col-xs-12">
                            <br>
                            <p style="margin-top:0;">Retrouvez les points de vue des apprenants qui commentent les formats, le contenu, la dynamique et les animations des formateurs DigitalAcademy sur une grande variété de thématiques.</p>
                        </div>
                    </div>
