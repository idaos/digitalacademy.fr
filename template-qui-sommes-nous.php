...
<div class="container content" style="height:initial;z-index: 5;">
	<div class="row">
	...
	<div class="row row-same-height team">
		<div class="col-md-4" style="max-width:408px;margin:auto;margin-top:0;margin-bottom:2em;">
			<center>
				...
				<p class="fonction">Directeur Conseil / Fondateur de la DigitalAcademy</p>
			</center>
		</div>
		<div class="col-md-4" style="max-width:408px;margin:auto;margin-top:0;margin-bottom:2em;">
			<center>
				<div class="wrapper"><img src="https://digitalacademy.fr/wp-content/uploads/2022/01/hannah.png" alt="" /></div>
				<p class="name"><strong>Hannah</strong></p>
				<p class="fonction">Developpeur LMS</p>
			</center>
		</div>
		<div class="col-md-4" style="max-width:408px;margin:auto;margin-top:0;margin-bottom:2em;">
			<center>
				<div class="wrapper"><img src="https://digitalacademy.fr/wp-content/uploads/2022/01/luis.png" alt="" /></div>
				<p class="name"><strong>Luis</strong></p>
				<p class="fonction">Responsable pédagogie & e-learning</p>
			</center>
		</div>
		<div class="col-md-4" style="max-width:408px;margin:auto;margin-top:0;margin-bottom:2em;">
			<center>
				<div class="wrapper"><img src="https://digitalacademy.fr/wp-content/uploads/2022/01/charles.png" alt="" /></div>
				<p class="name"><strong>Charles</strong></p>
				<p class="fonction">Chef de projet formation</p>
			</center>
		</div>
		<div class="col-md-4" style="max-width:408px;margin:auto;margin-top:0;margin-bottom:2em;">
			<center>
		...
		<div class="col-md-4" style="max-width:408px;margin:auto;margin-top:0;margin-bottom:2em;">
			<center>
				...
				<p class="fonction">Developpeur web / Webmaster</p>
			</center>
		</div>
		<div class="col-md-4" style="max-width:408px;margin:auto;margin-top:0;margin-bottom:2em;">
			<center>
