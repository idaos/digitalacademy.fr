    ...
    <div ng-app="courseFilteringApp" id="nos-formations">
        <div ng-controller="courseFilteringController as courses">
            ...
            <div id="formations" style="padding: 0;">
                <div ng-cloak on-finish-render="ngRepeatFinished" ng-repeat="thema in thema" class="animated-item" ng-show="thema.name.length > 1">
                    <div class="container">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <a class="swiper-slide col-md-6 col-xl-4 animated-item mb-4" ng-href="{{course.link}}" course-id="{{course.id}}" ng-cloak on-finish-render="ngRepeatFinished" ng-repeat="course in courses.course | filterThema: thema.slug:this">
                                <div class="card">
            ...
            <div ng-show="spinner == true" id="spinner-container">
...
<div class="content" style="background-color: #fff;">
    ...
    <div class="container" style="margin-top:3em;">
        <div class="wrapper">
            <h2 class="calendar-title hidden-xs">Calendrier des formations <?php echo $th->getName(); ?>
                <span id="selectedThema" ng-show="enableThemaFilter" ng-class="{'t1-c': thema.t1.enabled == true , 't2-c': thema.t2.enabled == true , 't3-c': thema.t3.enabled == true , 't4-c': thema.t4.enabled == true , 't5-c': thema.t5.enabled == true , 't6-c': thema.t6.enabled == true } "></span>
            </h2>
    ...
    <script>
        ...
        var phpSearchTerm = <?php if ($search_query) {
                                echo 'true';
                            } else {
                                echo 'false';
                            }; ?>;
