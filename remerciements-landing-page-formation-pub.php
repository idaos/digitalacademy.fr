<?php
/*
Template Name: Landing Page - Remerciements Formation pub FB & Insta
*/
?>
...
<script>
  ...
  gtag('config', 'UA-1188124-3');
    ...
    <title>Remerciements Formation pub Facebook & Instagram - DigitalAcademy</title>
            ...
            <div class="bloc-1">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <span class="reverse">
                                <h1>LA DIGITAL ACADEMY VOUS REMERCIE<br> POUR VOTRE DEMANDE !</h1>
                            </span>
				<a title="Inscription" class="contact-btn" href="https://www.digitalacademy.fr/formation-publicite-facebook-instagram/#calendly">
		<div class="btn btn-red">Prenez un rendez-vous avec votre conseiller</div>
				</a>
                            <br><br>
                        </div></a>
                    </div>
